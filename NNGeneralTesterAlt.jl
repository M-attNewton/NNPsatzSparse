...
global layers = 1
for a in [1:100; 105:5:500; 525:25:800; 850:50:1200] #550:50:2000 #1050:50:4000 #[1:20; 22:2:40] #[1:100; 105:5:500] #[1:100; 105:5:500] #[1:100; 105:5:500]#1:8#[1:20;22:2:40]#[1:100; 105:5:200]#[1:200; 205:5:400; 405:5:500; 510:10:1000]#1:50 #[1:200; 205:5:400; 405:5:500]
#[1:200, 205:5:400, 405:5:500, 510:10:1000]
global layers = vcat(layers,a)

# Read NN from file
local filename = string("matlabNNSavesTRUE\\net1x8x$a","x1relu.mat")
#local filename = string("matlabNNSavesTRUE\\net1x$a","x100x1relu.mat")
...
local weights = weights*10^-1
local biases = biases*10^-1
...
#global u_min = 0.999999999999*ones(dim_in,1)
#global u_max = 1.000000000001*ones(dim_in,1)

#global u_min = -0.1*ones(dim_in,1)
#global u_max = 0.1*ones(dim_in,1)

#local weights = 10^-10*weights
#local biases = 10^-10*biases
...
#matwrite("juliaResultsSavesNew\\8layer_relu_min_1to1200_1.mat", Dict("sol_time" => sol_time,"sol_accuracy" => sol_accuracy, "layers" => layers))#; compress = true)
